...
\begin{table*}[]
	...
	\begin{tabular}{r r r r r r r } 
		...
		& &  Case A & &  & Case B&\\
		\midrule
		 &	Applied firn diffusion  &	Est. firn diffusion & Est. T [$^o\mathrm{C}$] &	
		Applied firn diffusion	&	Est. firn diffusion 	& Est. T  [$^o\mathrm{C}$]\\
		\midrule
		$\sigma_{18}$	&	 $4.66$	 $\mathrm{cm}$&	$ 5.84\pm 0.13$ $\mathrm{cm}$	 &  $  -54.8 \pm 1.0 $ 	&	$8.50$  $\mathrm{cm}$&	$ 8.51 \pm 0.20$ $\mathrm{cm}$	& $ -28.8 \pm 1.2 $\\ 
	
	
		$\sigma_{\mathrm{D}}$&	$4.18$ $\mathrm{cm}$	&$ 5.23 \pm 0.11 $ $\mathrm{cm}$	 &	$-54.9  \pm 0.9 $ &	$ 7.86$	 $\mathrm{cm}$&	$7.86 \pm 0.18 $	$\mathrm{cm}$& 	$ -28.9\pm 1.1 $\\ 
	
	
		$\sigma_{17}$&	$4.72$ $\mathrm{cm}$	&$5.98 \pm 0.10 $ $\mathrm{cm}$	 &	$ -54.7 \pm 0.9$ &	$ 8.59$	 $\mathrm{cm}$&	$8.54 \pm 0.13 $	$\mathrm{cm}$& 	$-29.0 \pm 1.0 $\\ 	
	
	
		${}^{18}\Delta\sigma^2$  I &$ 4.2	$ $\mathrm{cm^2}$&	$ 6.8\pm 1.4 $ $\mathrm{cm^2}$	& $ -54.6 \pm 2.2$   &	$10.3$  $\mathrm{cm^2}$	&	$10.7 \pm 2.0$ $\mathrm{cm^2}$	&$ -28.5 \pm 3.5 $\\
	
	
		${}^{18}\Delta\sigma^2$  II& $4.2$ $\mathrm{cm^2}$	&	$6.6 \pm 0.7$ $\mathrm{cm^2}$	& $ -54.9 \pm 1.7$	&	$ 10.3$ $\mathrm{cm^2}$	&$10.5 \pm 1.2 $	 $\mathrm{cm^2}$& $-28.6 \pm 2.2$\\
	
	
		${}^{18}\Delta\sigma^2$  III& $4.2$ $\mathrm{cm^2}$	&	$6.0 \pm 0.3$ $\mathrm{cm^2}$		&  $-57.2  \pm 1.1$	&	$10.3$	 $\mathrm{cm^2}$&	 $9.7 \pm 0.6 $  $\mathrm{cm^2}$& $-30.0 \pm 1.4 $\\
	
	
		${}^{17}\Delta\sigma^2$  I &$ 4.8	$ $\mathrm{cm^2}$&	$ 8.4 \pm 0.8 $ $\mathrm{cm^2}$	& $-53.7  \pm 1.4$   &	$12.0$  $\mathrm{cm^2}$	&	$ 12.2\pm 2.0 $ $\mathrm{cm^2}$	&$-30.2 \pm 3.2$\\
	
	
		${}^{17}\Delta\sigma^2$  II& $4.8$ $\mathrm{cm^2}$	&	$7.5 \pm 0.6$ $\mathrm{cm^2}$	& $-54.9  \pm 1.5 $	&	$12.0$ $\mathrm{cm^2}$	&$ 12.4\pm 1.0$	 $\mathrm{cm^2}$& $-28.3 \pm 1.7 $\\
	
	
		$\sigma^2_{18}/\sigma^2_{17} $&$	0.975$& $ 0.956\pm 0.028 $ 	& --------------	&$0.977$*	& 	$0.993 \pm 0.035$* 	& -------------- \\
	
	
		$\sigma^2_{18}/\sigma^2_\mathrm{D} $&$	1.24$& $1.24 \pm 0.04 $ 	& $-56.6 \pm 11.1$	&$1.17$	& 	$1.17 \pm 0.03$ 	& $-28.2 \pm 19.3$\\
	
	
		$\sigma^2_{17}/\sigma^2_\mathrm{D} $&$	1.28$& $ 1.30 \pm 0.03 $ 	& $  -62.8 \pm 7.0$	&$1.20$	& 	$1.18 \pm 0.04$ 	& $ -16.1 \pm 27 $\\
		\bottomrule		
	\end{tabular}
	\caption{Simulations with synthetic data. The applied diffusion lengths are shown 
