...
\item{$\tau$: The firn tortuosity. We use \citep{Schwander1988} while more recent results include \citet{Freitag2002} and \citet{Adolph2014}:
\begin{equation}
...
For each data section we have the estimated uncorrected diffusion lenghts in a table.
...
\begin{figure}[H]
	...
	\begin{center}
		...
		\caption{NGRIP. Early Holocene power spectra of \delOx.}  \label{fig:NGRIP_late}
	\end{center}
\end{figure}
...
\begin{figure}[H]
	...
	\begin{center}
		...
		\caption{NGRIP early Holocene core 1. Power spectra of \delOx.}  \label{fig:NGRIP_early1}
	\end{center}
\end{figure}
...
\begin{figure}[H]
	...
	\begin{center}
		...
		\caption{NGRIP early Holocene core 2. Power spectra of \delOx.}  \label{fig:NGRIP_early2}
	\end{center}
\end{figure}
